...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CIconButton* DefaultIconButtonFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCIconButton*>();
        l_Element->Init();
