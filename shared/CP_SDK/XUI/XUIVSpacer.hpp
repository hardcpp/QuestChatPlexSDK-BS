...
namespace CP_SDK::XUI {
    ...
    {
        DISABLE_COPY_MOVECONSTRUCTORS(XUIVSpacer);
        PRIVATE_TAG();
        ...
        public:
            ...
            XUIVSpacer(PRIVATE_TAG_ARG(), float p_Spacing)
                : XUIVSpacer(PRIVATE_TAG_FWD(), u"XUIVSpacer", p_Spacing)
            { }
            XUIVSpacer(PRIVATE_TAG_ARG(), std::u16string_view p_Name, float p_Spacing)
        ...
        public:
            ...
            {
                return std::make_shared<XUIVSpacer>(PRIVATE_TAG_VAL(), p_Spacing);
            }
            /// @brief Constructor
            ...
            {
                return std::make_shared<XUIVSpacer>(PRIVATE_TAG_VAL(), p_Name, p_Spacing);
            }
