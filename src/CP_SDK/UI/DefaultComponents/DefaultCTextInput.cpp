...
namespace CP_SDK::UI::DefaultComponents {
    ...
    /// @brief Constructor
    CP_SDK_IL2CPP_DECLARE_CTOR_CHAIN_IMPL(DefaultCTextInput, Components::CTextInput)
    {
    ...
    /// @brief Destructor
    CP_SDK_IL2CPP_DECLARE_DTOR_MONOBEHAVIOUR_CHAIN_IMPL(DefaultCTextInput, Components::CTextInput)
    {
    ...
    void DefaultCTextInput::Init_DefaultCTextInput()
    {
        ...
        l_Colors.set_normalColor        (ColorU::Convert(Color32(255, 255, 255, 127)));
