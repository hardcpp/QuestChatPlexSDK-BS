...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CTextInput* DefaultTextInputFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCTextInput*>();
        l_Element->Init();
