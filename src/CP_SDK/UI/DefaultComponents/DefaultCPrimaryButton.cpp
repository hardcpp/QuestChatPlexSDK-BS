...
namespace CP_SDK::UI::DefaultComponents {
    ...
    CP_SDK_IL2CPP_INHERIT_INIT(DefaultCPrimaryButton);

    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////

    /// @brief Constructor
    CP_SDK_IL2CPP_DECLARE_CTOR_CHAIN_IMPL(DefaultCPrimaryButton, Components::CPrimaryButton)
    {
        ...
        m_OnClick       = {this, &DefaultCPrimaryButton::OnClick_Impl};
        m_SetTooltip    = {this, &DefaultCPrimaryButton::SetTooltip_Impl};

        Init += {this, &DefaultCPrimaryButton::Init_DefaultCPrimaryButton};
    }
    /// @brief Destructor
    CP_SDK_IL2CPP_DECLARE_DTOR_MONOBEHAVIOUR_CHAIN_IMPL(DefaultCPrimaryButton, Components::CPrimaryButton)
    {
    ...
    void DefaultCPrimaryButton::Init_DefaultCPrimaryButton()
    {
        if (m_RTransform)
            return;
        ...
        m_BackgroundImage->set_color                        (UISystem::PrimaryColor);
        ...
        m_Button->get_onClick()->AddListener(MakeUnityAction(std::bind(&DefaultCPrimaryButton::Button_OnClick, this)));
    ...
    void DefaultCPrimaryButton::OnClick_Impl(_v::CActionRef<> p_Functor, bool p_Add)
    {
    ...
    void DefaultCPrimaryButton::SetTooltip_Impl(std::u16string_view p_Tooltip)
    {
        m_Tooltip = p_Tooltip;
    }
    ...
    void DefaultCPrimaryButton::Button_OnClick()
    {
        try { m_OnClickEvent(); }
        catch (const std::exception& l_Exception)
        {
            ChatPlexSDK::Logger()->Error(u"[CP_SDK.UI.DefaultComponents][DefaultCPrimaryButton.Button_OnClick] Error:");
    ...
    void DefaultCPrimaryButton::IPointerEnterHandler__OnPointerEnter(PointerEventData* p_EventData)
    {
        if (m_Tooltip.size() == 0)
            return;
    ...
    /// @param p_EventData Event data
    void DefaultCPrimaryButton::IPointerExitHandler__OnPointerExit(PointerEventData* p_EventData)
    {
        auto l_ViewController = get_gameObject()->GetComponentInParent<IViewController*>();
        if (!l_ViewController)
            return;
