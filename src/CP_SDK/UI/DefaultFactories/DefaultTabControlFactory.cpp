...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CTabControl* DefaultTabControlFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCTabControl*>();
        l_Element->Init();
