...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CText* DefaultTextFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCText*>();
        l_Element->Init();
