...
namespace CP_SDK::UI::Modals {
    ...
    {
        CP_SDK_IL2CPP_INHERIT_CUSTOM("CP_SDK.UI.Modals", Message, IModal);
        CP_SDK_IL2CPP_DECLARE_CTOR_CHAIN(Message, IModal);
        CP_SDK_IL2CPP_DECLARE_DTOR_MONOBEHAVIOUR_CHAIN(Message, IModal);
