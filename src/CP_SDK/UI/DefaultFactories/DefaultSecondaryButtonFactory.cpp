...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CSecondaryButton* DefaultSecondaryButtonFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCSecondaryButton*>();
        l_Element->Init();
