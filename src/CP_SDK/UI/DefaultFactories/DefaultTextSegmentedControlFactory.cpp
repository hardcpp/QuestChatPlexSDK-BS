...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CTextSegmentedControl* DefaultTextSegmentedControlFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCTextSegmentedControl*>();
        l_Element->Init();
