...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CVVList* DefaultVVListFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCVVList*>();
        l_Element->Init();
