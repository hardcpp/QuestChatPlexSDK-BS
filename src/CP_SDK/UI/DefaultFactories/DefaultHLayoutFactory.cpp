...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CHLayout* DefaultHLayoutFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCHLayout*>();
        l_Element->Init();
