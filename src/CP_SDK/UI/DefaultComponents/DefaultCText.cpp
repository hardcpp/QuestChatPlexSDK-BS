...
namespace CP_SDK::UI::DefaultComponents {
    ...
    void DefaultCText::Init_DefaultCText()
    {
        ...
        m_TMProUGUI = get_gameObject()->AddComponent(UISystem::Override_UnityComponent_TextMeshProUGUI.ptr()).try_cast<TextMeshProUGUI>().value_or(nullptr);
        m_TMProUGUI->set_font               (UISystem::Override_GetUIFont()                 ? UISystem::Override_GetUIFont()                : m_TMProUGUI->get_font().ptr());
        m_TMProUGUI->set_fontSharedMaterial (UISystem::Override_GetUIFontSharedMaterial()   ? UISystem::Override_GetUIFontSharedMaterial()  : m_TMProUGUI->get_fontSharedMaterial().ptr());
