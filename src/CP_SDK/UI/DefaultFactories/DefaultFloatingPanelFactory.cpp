...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CFloatingPanel* DefaultFloatingPanelFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCFloatingPanel*>();
        l_Element->Init();
