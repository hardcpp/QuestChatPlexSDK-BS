...
namespace CP_SDK::UI::DefaultFactories {
    ...
    Components::CToggle* DefaultToggleFactory::Create(std::u16string_view p_Name, Transform* p_Parent)
    {
        ...
        auto l_Element = l_GameObject->AddComponent<DefaultComponents::DefaultCToggle*>();
        l_Element->Init();
